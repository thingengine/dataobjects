...
class Comment
{
    ...
    public function setByToken($value = null) : Self
    {
        if(!Validator::stringType()->length(1, 36)->validate($value))
        {
            throw new \InvalidArgumentException("token must be between 1 and 36 Characters");
    ...
    public function setCommentType($value = null) : Self
    {
    ...
    public function setComment($value = null) : Self
    {
        $this->comment = $value;
        return $this;
    }
